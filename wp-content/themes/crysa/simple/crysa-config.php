<?php
    ...
    Redux::setSection($opt_name, array(
        'title'     => __('Header Options', 'crysa'),
        'id'        => 'header-options',
        'fields'    => array(
            array(
               'id'      => 'upload_header_logo',
               'title'   => __('Upload Header Logo Dark','crysa'), 
               'type'    => 'media',  
            ),
            array(
               'id'      => 'upload_header_logo_light',
               'title'   => __('Upload Header Logo Light','crysa'), 
               'type'    => 'media',  
            ),
            array(
                'id'               => 'header_info',
            ...
            array(
                'id'      => 'header_working_hrs',
                'type'    => 'text',
                'title'   => __('Working Hours', 'crysa'),  
            ),
            array(
                'id'       => 'header_fb_url',
                'type'     => 'text',
            ...
            array(
                'id'       => 'header_quote_icon',
                'type'     => 'text',
                'title'    => 'Header Icon'
            ),
            array(
               'id'      => 'header_quote_text',
               'title'   => __('Header Quote Text','crysa'), 
               'type'    => 'text',
            ),
            array(
               'id'      => 'header_quote_url',
               'title'   => __('Header Quote URL','crysa'), 
               'type'    => 'text',
            ),
            array(
               'id'      => 'header_phone_logo',
               'title'   => __('Upload Phone Logo','crysa'), 
               'type'    => 'media',  
            ),
            array(
               'id'      => 'header_contact_text',
               'title'   => __('Header Contact Text','crysa'), 
               'type'    => 'text',
            ),
            array(
               'id'      => 'header_contact_mail',
               'title'   => __('Header Contact Mail','crysa'), 
               'type'    => 'text',
            ),   
        )
    ));
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'    => array(
            array(
                'id'               => 'footer_txt',
                'type'             => 'editor',
                'title'            => __('Footer Copyright Text', 'crysa'), 
                'args'   => array(
                'teeny'            => true,
                'textarea_rows'    => 10,
                ),
